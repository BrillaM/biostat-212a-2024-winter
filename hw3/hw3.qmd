...
a.
**answer:** decrease, as increase s from 0, we are restricting the βj coefficients less and less. The model is becoming more flexible, and the training RSS will decrease.

b.
**answer:** decrease first, then increase like U shape. As we increase s from 0, we are restricting the βj coefficients less and less. The model is becoming more flexible, and the test RSS will decrease. However, after a certain point, the model will become too flexible and will overfit the training data, so the test RSS will begin to increase.

c.
**answer:** increase. As we increase s from 0, we are restricting the βj coefficients less and less. so the model is becoming more and more flexible which provokes a steady increase in variance.

d.
**answer:** decrease. As we increase s from 0, we are restricting the βj coefficients less and less. The model is becoming more flexible, and the bias will decrease.
