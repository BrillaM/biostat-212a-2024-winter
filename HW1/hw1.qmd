...
data <- data.frame(flexibility, bias_squared, variance, training_error, test_error, irreducible_error)
...
Crime is very high compare to median and average rates of all Boston neighborhoods. No 
